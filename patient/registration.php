...
if (isset($_REQUEST["submit"])) {
  ...
  $db->query("INSERT INTO `patients`(`id`, `name`, `address`, `dob`, `gender`, `blood_grp`, `email`, `password`, `phone`) VALUES (NULL, '$name','$address','$dob','$gender', '$blood', '$email','$password','$phone')");
  if ($db->affected_rows) {
...
<head>
  ...
  <title>TrueMedicare Haven | Registration Patients</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Registration Patients</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                <li class="breadcrumb-item active">Registration Patients</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
