...
// query for admin
$result = $db->query("SELECT * FROM treatment")
?>
...
<head>
  ...
  <title>TrueMedicare Haven | View Treatment</title>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">View Treatment</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
