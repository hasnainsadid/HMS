<?php 
  ...
  if (isset($_REQUEST['submit'])) {
    extract($_REQUEST);
    $db->query("UPDATE department SET name='$name', description = '$description', status='$status' WHERE id='$id'");
    if ($db->affected_rows) {
      echo "<script>alert('Updated Successfully.')</script>";
    }
  }

  $result=$db->query("SELECT * FROM department WHERE id='$id'");
...
<head>
  ...
  <title>TrueMedicare Haven | Edit Department</title>
                ...
                <form method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="description" class="form-control form-control-border" id="exampleInputEmail1" value="<?php echo $row->description ?>">
                    </div>
                  ...
                  <div class="card-footer">
                    ...
                    <a class="btn btn-success m-auto d-block w-25" href="./view_departments.php">Go to Department List</a>
                  </div>
                </form>
              </div>
            </div>
