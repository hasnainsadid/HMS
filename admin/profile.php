...
<head>
  ...
  <title>TrueMedicare Haven | Admin Profile</title>
                ...
                <form>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="status" class="form-control form-control-border" id="exampleInputPassword1" value="<?php echo ($_SESSION['status'] == 0) ? "Inactive" : "Active" ?> " readonly>
                    </div>
                  </div>
                </form>
              </div>
