...
$result = $db->query("SELECT * FROM appointment_view WHERE status='1' ORDER BY date DESC");
?>
...
<head>
  ...
  <title>TrueMedicare Haven | Approve Appointment</title>
                    ...
                    <tbody>
                      ...
                      while ($row = $result->fetch_object()) : ?>
                        <tr>
                          ...
                          <td><b><?php echo ($row->status == 1) ? "Approved" : "Prending"; ?></b></td>
                        </tr>
                      <?php endwhile; ?>
                    </tbody>
                  </table>
